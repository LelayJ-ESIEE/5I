...
//
public class Step4_Converge_EachOther : MonoBehaviour {
	...
	void Update()
	{
		...
		for(int i = 0; i < nbPoints; ++i)
		{
			...
			for(int j = i+1; j < nbPoints; ++j)
			{
				...
				GVector3 mouvementIJ = IJ.getNormalized() * timeSinceLastFrame_s;
				lMouvementPoints[i] += mouvementIJ;
				lMouvementPoints[j] -= mouvementIJ;
			}
		}
