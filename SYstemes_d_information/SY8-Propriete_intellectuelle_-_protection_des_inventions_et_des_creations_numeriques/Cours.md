...
- Inventions (Solution technique à un problème technique)
- Savoir-faire
- Logiciels
- Bases de données
- Signes distinctifs
...
Invention : Solution technique, par l'humain, à un problème technique

⚠️ Différent de :
- Découverte : Notion de compréhension d'un phénomène existant, incidence indirecte.
- Innovation : application réussie d'une invention sur le plan commercial.
...
- Protection durant 20 ans
- Protection territoriale

Le brevet est un contrat entre l'entreprise créatrice d'une technologie innovante et la société, pour protéger la première de la contrefaçon en échange de la publication de sa création.
...
- Idées abstraites
- Méthodes d'affaires
- Logiciels en tant que tels (code source)

#### Conditions de brevetabilité
- Nouvelle : l'invention n'est pas comprise dans l'état de la technique ;
- Inventive : l'invention implique une activité inventive, elle ne découle pas clairement de l'état de la technique pour un homme du métier (critère de non-évidence) ;
- Susceptible d'application industrielle : l'objet de l'invention peut être fabriqué ou utilisé dans tout (au moins un) type d'industrie, y compris l'agriculture.

⚠️ Un brevet est un droit d'interdire, pas un droit d'exploitation (possibilité de défaillance, pouvant mener à des poursuites d'invalidation ou de contrefaçon)

⚠️ [Paternité des brevets](https://economie.fgov.be/fr/themes/propriete-intellectuelle/innovation-et-propriete/creations-realisees-dans-le/les-brevets)

#### Démarches
- Remplir un formulaire de dépôt
- Rédiger une demande de brevet (⚠️ c'est un métier !)
- Payer le dépôt et les frais de recherche

##### Procédure de délivrance en France
\[Voir slides pour timeline]

#### Avantages et inconvénients
##### Avantages
- Monopole d'exploitation pendant 20 ans
- Possibilité de concession de licence ou de cession de droits
- \[...]
...
## La protection des savoir-faire par le secret

Savoir-faire : information ou connaissance qui 
- n'est pas généralement connue ou aisément accessible \[...]
- \[...]
\[Voir slides]

⚠️ != Secret des affaires : Savoir-faire + Informations commerciales (organisation des équipes, comptabilité)

### Le caractère secret
- Information non directement accessible au public
- La valeur de l'information réside dans son caractère secret
- L'information tombe dans le domaine public en cas de perte du caractère secret
- La compilation et l'exploitation d'informations publiques peuvent faire l'objet d'une prestation mais ne constituent en aucun cas un savoir-faire

#### Le caractère substantiel
Critère d'utilité économique : les informations sont toujours identifiées par rapport à leur utilité \[...]

#### Les caractères identifié et transmissible

### Exemples
- Procédé de fabrication assurant une meilleur productivité
...
- Ensembles des publications

### Avantages et inconvénients
#### Avantages
- Aucune divulgation
- Durée de protection "illimitée"
- Aucune procédure officielle

#### Inconvénients
- Attention aux publications
- Politique de confidentialité stricte
- Blocage de brevets par des tiers
