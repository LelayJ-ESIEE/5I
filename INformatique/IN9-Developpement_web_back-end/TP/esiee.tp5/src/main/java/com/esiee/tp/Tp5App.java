package com.esiee.tp;

import com.esiee.tp.config.Constants;
import com.esiee.tp.config.JHipsterProperties;
...
public class Tp5App {
    ...
    private static final Logger log = LoggerFactory.getLogger(Tp5App.class);
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Tp5App.class);
